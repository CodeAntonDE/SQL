...
5. Порядок выполнения в запросе
Оконные функции вычисляются после фильтрации (WHERE), группировки (GROUP BY) и условий (HAVING), но перед сортировкой (ORDER BY). Это влияет на доступные данные для расчета.

Пример различия между агрегатной и оконной функцией
Агрегатная функция (сворачивает строки):
...
FROM employees 
GROUP BY department;
Результат: одна строка на каждый отдел со средней зарплатой.
...
FROM employees;
Результат: все сотрудники, их зарплата и средняя зарплата по их отделу в каждой строке.

Как проверить, что функция оконная?
Если в запросе функция вызывается с OVER() — это оконная функция. Если OVER() отсутствует — это либо агрегатная, либо скалярная функция.

***************************************************************************************************************************************************************
# 10) Назови виды оконных функций.
![image](https://github.com/user-attachments/assets/db4007a4-7733-446a-bb0f-b5f6e0d511c2)

![image](https://github.com/user-attachments/assets/6ae929c9-7977-4b9a-b899-e6ce5709c8d4)

![image](https://github.com/user-attachments/assets/2799736e-f7c6-4c5b-8c96-9d116df4a418)

***************************************************************************************************************************************************************
# 11) Как ты понимаешь, для чего нужно оптимизировать запросы?

![image](https://github.com/user-attachments/assets/e4e45499-8ea8-4e35-9e6e-f1939c544487)

![image](https://github.com/user-attachments/assets/0950920d-8bef-4a1e-8743-4a457a028519)

***************************************************************************************************************************************************************
# 12) В чем различия команд EXPLAIN и EXPLAIN ANALYZE?

![image](https://github.com/user-attachments/assets/d262aa5d-a540-47bb-aad0-f9e8ad15c92c)

![image](https://github.com/user-attachments/assets/98c2198a-fceb-448f-986a-d114f6cf3810)


***************************************************************************************************************************************************************
# 13)  Расскажи алгоритм того, как бы ты оптимизировал запрос.

![image](https://github.com/user-attachments/assets/6ab49c8b-8b5f-4298-b4f9-e77b92bb2fe2)

![image](https://github.com/user-attachments/assets/ce0e7988-e1bd-45d6-b51d-433096ad52a0)

***************************************************************************************************************************************************************
# 14) Что делают команды VACUUM, ANALYZE и VACUUM ANALYZE?

![image](https://github.com/user-attachments/assets/d4be8cf4-c219-4e93-8354-fe2047bd2c3e)
...
# 16) Как посчитать среднее значение? (Вопрос с подвохом)

![image](https://github.com/user-attachments/assets/3098097f-73c2-4b29-a62c-4e2e1db7dd81)

***************************************************************************************************************************************************************

# 17) Какими конструкциями дополняется ORDER BY, чтобы значения NULL стояли в начале и в конце таблицы?

![image](https://github.com/user-attachments/assets/29e68f77-d201-46d2-bd36-ea4c20eb0ac6)

![image](https://github.com/user-attachments/assets/41134b93-b41e-413b-972f-fffd0f3c253c)

***************************************************************************************************************************************************************

# 18) Для чего нужна временная таблица, если есть CTE?
...
# 21) В таблице 100 млн строк, необходимо удалить 90 млн. Как ты это сделаешь и почему?


![image](https://github.com/user-attachments/assets/2cb292ca-a778-402c-b80e-c4153c16da4b)
